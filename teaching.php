...
<html lang="en">
	<head>
		...
		?>
		<meta name="description" content="The teaching of Daniel D. Lascar, Ph.D.">
		<?php	
			include 'includes/header_mid.php' ;
		?>
		<title>Teaching by Daniel D. Lascar, Ph.D.</title>
		<?php
	...
	<div class="container">
			...
			<div class="col-md-3">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<iframe width="100%" src="https://www.youtube.com/embed/T-jr3D1OWxA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">Course Lectures</h3>
					</div>
					<div class="panel-body">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<br>
				<p>Later, as a postdoctoral fellow, I took the opportunity to be a guest lecturer for several nuclear physics and nuclear chemistry courses at both The University of British Columbia and Simon Fraser University.</p>
				<br>
				<p><a href="docs/LASCAR_American.pptx">This is a lecture</a> I recently gave at American University in Washington, DC.</p>
			</div>
			<div class="col-md-3">
				<br>
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">Class Lectures</h3>
					</div>
					<div class="panel-body">
		...
		<div class="row">
			<div class="col-md-3"></div>
			<div class="col-md-6">
				<h2>General Public Outreach</h2>
				<br>
				<p>As important as it is to help grow the next generation of physicists, improving the public's understanding of science through community outreach is equally important as it helps ensure a degree of scientific literacy in the country.</p>
				<br>
				<p>One of the most enjoyable public lectures I ever presented was a joint lecture I gave on the physics of baseball for the University of Chicago Alumni Association's annual excursion to a Chicago White Sox game in 2012. Along with my friend and University of Chicago physics alumnus, <a href="http://mag.uchicago.edu/benjamin-recchie-ab%E2%80%9903" target="_blank">Benjamin Recchie</a>, I gave a lecture on the physics of pitching while Ben gave the lecture on the physics of hitting.</p>
			</div>
			<div class="col-md-3">
				<br><br>
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">Public Lectures</h3>
					</div>
					<div class="panel-body">
						<p><a href="docs/PoB.pptx">Physics of Baseball</a></p>
					</div>
				</div>
			</div>
		</div>
